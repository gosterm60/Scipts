...
veeamInfluxDBURL="http://='***FQDN***'" #Your InfluxDB Server, http://FQDN or https://FQDN if using SSL
veeamInfluxDBPort="8086" #Default Port
veeamInfluxDB="='******'" #Default Database
veeamInfluxDBUser="='******'" #User for Database
veeamInfluxDBPassword='******' #Password for Database

# Endpoint URL for login action
veeamUsername="***user***" #Your username, if using domain based account, please add it like user@domain.com (if you use domain\account it is not going to work!)
veeamPassword='xxx'
veeamJobSessions="100"
veeamAuth=$(echo -ne "$veeamUsername:$veeamPassword" | base64);
veeamRestServer="***FQDN***"
