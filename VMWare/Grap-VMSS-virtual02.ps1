...
$username = 'root' 
$password = 'xxxxx' #Change to the root password you set for you ESXi server 
...
$ServerList = "192.168.2.15"    #Chance to DNS Names/IP addresses of your ESXi servers or Virtual Center Server 
...
Generate-Report > "VmwareSnapshots.html" 
    ...
    $SmtpClient.host = "ip"   #Change to a SMTP server in your environment 
    $MailMessage = New-Object system.net.mail.mailmessage 
    $MailMessage.from = "smtp@"   #Change to email address you want emails to be coming from 
    $MailMessage.To.add("smtp@")    #Change to email address you would like to receive emails. 
